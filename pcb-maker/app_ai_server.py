...
# ===================================================================
# ALLEGRO X -- AUTONOMOUS CIRCUIT KNOWLEDGE ENGINE v3.0
# 30+ circuit templates with full netlists, component values,
# placement hints, and fuzzy natural language matching.
# ===================================================================
...
CIRCUIT_TEMPLATES = {
    ...
    "555_monostable": {
        "keywords": ["monostable", "one shot", "single pulse", "delay timer"],
        "description": "NE555 Monostable - single timed pulse on trigger",
        "components": [
            {"type": "ic",        "ref": "U1", "label": "NE555",  "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "capacitor", "ref": "C1", "label": "10uF",   "zone": "center", "value": "10uF"},
            {"type": "capacitor", "ref": "C2", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "switch",    "ref": "SW1","label": "TRIG",   "zone": "left"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "OUT",    "zone": "right"},
        ],
    ...
    "led_array": {
        "keywords": ["led array", "multiple led", "led strip", "led bar", "chaser"],
        "description": "5-LED array with individual current limiting resistors",
        "components": [
            {"type": "resistor",  "ref": "R1", "label": "220R",   "zone": "center", "value": "220"},
            {"type": "resistor",  "ref": "R2", "label": "220R",   "zone": "center", "value": "220"},
            {"type": "resistor",  "ref": "R3", "label": "220R",   "zone": "center", "value": "220"},
            {"type": "resistor",  "ref": "R4", "label": "220R",   "zone": "center", "value": "220"},
            {"type": "resistor",  "ref": "R5", "label": "220R",   "zone": "center", "value": "220"},
            {"type": "led",       "ref": "D1", "label": "RED",    "zone": "right"},
            {"type": "led",       "ref": "D2", "label": "GRN",    "zone": "right"},
            {"type": "led",       "ref": "D3", "label": "BLU",    "zone": "right"},
            {"type": "led",       "ref": "D4", "label": "YEL",    "zone": "right"},
            {"type": "led",       "ref": "D5", "label": "WHT",    "zone": "right"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["J1.1", "R1.1", "R2.1", "R3.1", "R4.1", "R5.1"],
            ["R1.2", "D1.A"], ["R2.2", "D2.A"], ["R3.2", "D3.A"],
            ["R4.2", "D4.A"], ["R5.2", "D5.A"],
            ["D1.K", "D2.K", "D3.K", "D4.K", "D5.K", "J2.1"],
        ]
    },
    ...
    "3v3_regulator": {
        "keywords": ["3.3v", "3v3", "ldo", "ams1117"],
        "description": "3.3V LDO Regulator (AMS1117-3.3)",
        "components": [
            {"type": "connector", "ref": "J1", "label": "VIN",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "capacitor", "ref": "C1", "label": "10uF",   "zone": "left",   "value": "10uF"},
            {"type": "regulator", "ref": "U1", "label": "AMS1117","zone": "center"},
            {"type": "capacitor", "ref": "C2", "label": "22uF",   "zone": "right",  "value": "22uF"},
            {"type": "connector", "ref": "J3", "label": "3V3OUT", "zone": "right"},
        ],
        "nets": [
            ["J1.1", "C1.1", "U1.IN"],
            ["U1.GND", "J2.1", "C1.2", "C2.2"],
            ["U1.OUT", "C2.1", "J3.1"],
        ]
    },

    "battery_power": {
        "keywords": ["battery", "portable", "coin cell", "cr2032"],
        "description": "Battery-powered supply with switch and decoupling",
        "components": [
            {"type": "battery",   "ref": "BT1","label": "CR2032", "zone": "left"},
            {"type": "switch",    "ref": "SW1","label": "ON/OFF", "zone": "left"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "led",       "ref": "D1", "label": "PWR",    "zone": "right"},
            {"type": "resistor",  "ref": "R1", "label": "1k",     "zone": "right",  "value": "1k"},
            {"type": "connector", "ref": "J1", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["BT1.1", "SW1.1"],
            ["SW1.2", "C1.1", "R1.1", "J1.1"],
            ["R1.2", "D1.A"],
            ["D1.K", "BT1.2", "C1.2", "J2.1"],
        ]
    },
    ...
    "inverting_amp": {
        "keywords": ["inverting", "op amp", "opamp", "gain"],
        "description": "Inverting Op-Amp Amplifier with adjustable gain",
        "components": [
            {"type": "opamp",     "ref": "U1", "label": "LM358",  "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "100k",   "zone": "center", "value": "100k"},
            {"type": "connector", "ref": "J1", "label": "VIN",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "GND",    "zone": "left"},
        ],
        "nets": [
    ...
    "mosfet_switch": {
        "keywords": ["mosfet", "fet", "irf540", "power switch", "high current"],
        "description": "N-Channel MOSFET Power Switch for high-current loads",
        "components": [
            {"type": "mosfet",    "ref": "Q1", "label": "IRF540", "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "100R",   "zone": "center", "value": "100"},
            {"type": "diode",     "ref": "D1", "label": "1N4007", "zone": "center"},
            {"type": "connector", "ref": "J1", "label": "GATE",   "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "LOAD",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "V+",     "zone": "right"},
            {"type": "connector", "ref": "J4", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["J1.1", "R2.1"],
    ...
    # -- SENSOR CIRCUITS ----------------------------------------
    "temp_sensor": {
        "keywords": ["temperature", "sensor", "lm35", "thermometer", "temp"],
        "description": "LM35 Temperature Sensor with analog output",
        "components": [
            {"type": "sensor",    "ref": "U1", "label": "LM35",   "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "AOUT",   "zone": "right"},
        ],
        "nets": [
            ["J1.1", "U1.VCC", "C1.1"],
            ["U1.OUT", "J3.1"],
    ...
    "light_sensor": {
        "keywords": ["light", "ldr", "photoresistor", "brightness", "light sensor"],
        "description": "LDR Light Sensor with voltage divider output",
        "components": [
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "LDR",    "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "AOUT",   "zone": "right"},
    ...
    "pir_motion": {
        "keywords": ["pir", "motion", "motion sensor", "infrared", "presence"],
        "description": "PIR Motion Sensor module with indicator LED",
        "components": [
            {"type": "sensor",    "ref": "U1", "label": "PIR",    "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "330R",   "zone": "right",  "value": "330"},
            {"type": "led",       "ref": "D1", "label": "IND",    "zone": "right"},
            {"type": "capacitor", "ref": "C1", "label": "10uF",   "zone": "left",   "value": "10uF"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "DOUT",   "zone": "right"},
        ],
        "nets": [
            ["J1.1", "U1.VCC", "C1.1"],
            ["U1.OUT", "R1.1", "J3.1"],
            ["R1.2", "D1.A"],
            ["D1.K", "J2.1", "U1.GND", "C1.2"],
        ]
    },

    # -- FILTER CIRCUITS ----------------------------------------
    "low_pass_rc": {
        "keywords": ["low pass", "filter", "rc filter", "noise filter", "lpf"],
        "description": "RC Low-Pass Filter for noise reduction",
        "components": [
            {"type": "resistor",  "ref": "R1", "label": "1k",     "zone": "center", "value": "1k"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "connector", "ref": "J1", "label": "IN",     "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "OUT",    "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["J1.1", "R1.1"],
            ["R1.2", "C1.1", "J2.1"],
    ...
    "high_pass_rc": {
        "keywords": ["high pass", "hpf", "ac coupling", "dc block"],
    ...
    # -- MOTOR CONTROL ------------------------------------------
    "h_bridge": {
        "keywords": ["h-bridge", "motor", "dc motor", "motor driver", "h bridge", "bidirectional"],
        "description": "H-Bridge DC Motor Driver with direction control",
        "components": [
            {"type": "mosfet",    "ref": "Q1", "label": "IRF540", "zone": "center"},
            {"type": "mosfet",    "ref": "Q2", "label": "IRF540", "zone": "center"},
            {"type": "mosfet",    "ref": "Q3", "label": "IRF540", "zone": "center"},
            {"type": "mosfet",    "ref": "Q4", "label": "IRF540", "zone": "center"},
            {"type": "diode",     "ref": "D1", "label": "1N4007", "zone": "center"},
            {"type": "diode",     "ref": "D2", "label": "1N4007", "zone": "center"},
            {"type": "diode",     "ref": "D3", "label": "1N4007", "zone": "center"},
            {"type": "diode",     "ref": "D4", "label": "1N4007", "zone": "center"},
            {"type": "connector", "ref": "J1", "label": "MOTOR+", "zone": "right"},
            {"type": "connector", "ref": "J2", "label": "MOTOR-", "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J5", "label": "IN1",    "zone": "left"},
            {"type": "connector", "ref": "J6", "label": "IN2",    "zone": "left"},
        ],
        "nets": [
            ["J3.1", "Q1.D", "Q3.D", "D1.K", "D3.K"],
            ["Q1.S", "Q2.D", "J1.1", "D1.A", "D2.K"],
            ["Q3.S", "Q4.D", "J2.1", "D3.A", "D4.K"],
            ["Q2.S", "Q4.S", "J4.1", "D2.A", "D4.A"],
            ["J5.1", "Q1.G", "Q4.G"],
            ["J6.1", "Q2.G", "Q3.G"],
        ]
    },
    ...
    # -- RELAY CIRCUITS -----------------------------------------
    "relay_driver": {
        "keywords": ["relay", "switch", "relay driver", "contactor", "solenoid"],
        "description": "Transistor-driven Relay with flyback diode",
        "components": [
            {"type": "relay",     "ref": "RL1","label": "5V-RLY", "zone": "center"},
            {"type": "transistor","ref": "Q1", "label": "2N2222", "zone": "center"},
            {"type": "diode",     "ref": "D1", "label": "1N4007", "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "1k",     "zone": "left",   "value": "1k"},
            {"type": "connector", "ref": "J1", "label": "CTRL",   "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "COM",    "zone": "right"},
            {"type": "connector", "ref": "J5", "label": "NO",     "zone": "right"},
        ],
        "nets": [
            ["J1.1", "R1.1"],
            ["R1.2", "Q1.B"],
    ...
    "overvoltage_protection": {
        "keywords": ["protection", "overvoltage", "tvs", "clamp", "surge"],
        "description": "Overvoltage Protection with TVS diode and fuse",
        "components": [
            {"type": "fuse",      "ref": "F1", "label": "500mA",  "zone": "left"},
            {"type": "diode",     "ref": "D1", "label": "TVS",    "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "connector", "ref": "J1", "label": "VIN",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "GND",    "zone": "left"},
    ...
    "reverse_polarity": {
        "keywords": ["reverse polarity", "polarity protection", "reverse voltage"],
        "description": "Reverse Polarity Protection using P-MOSFET",
        "components": [
            {"type": "mosfet",    "ref": "Q1", "label": "IRF9540", "zone": "center"},
            {"type": "fuse",      "ref": "F1", "label": "1A",     "zone": "left"},
            {"type": "connector", "ref": "J1", "label": "VIN",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "GND",    "zone": "left"},
        ],
    ...
    # -- MCU / MICROCONTROLLER ----------------------------------
    "arduino_minimal": {
        "keywords": ["arduino", "atmega", "microcontroller", "mcu", "avr", "328p"],
        "description": "Minimal ATmega328P MCU system with crystal and decoupling",
        "components": [
            {"type": "ic",        "ref": "U1", "label": "ATmega328P", "zone": "center"},
            {"type": "crystal",   "ref": "Y1", "label": "16MHz",  "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "22pF",   "zone": "center", "value": "22pF"},
            {"type": "capacitor", "ref": "C2", "label": "22pF",   "zone": "center", "value": "22pF"},
            {"type": "capacitor", "ref": "C3", "label": "100nF",  "zone": "left",   "value": "100nF"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "RESET",  "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "GPIO",   "zone": "right"},
        ],
        "nets": [
            ["J1.1", "U1.VCC", "C3.1", "R1.1"],
            ["J2.1", "U1.GND", "C3.2", "C1.2", "C2.2"],
            ["U1.XTAL1", "Y1.1", "C1.1"],
            ["U1.XTAL2", "Y1.2", "C2.1"],
            ["R1.2", "U1.RESET", "J3.1"],
            ["U1.PB0", "J4.1"],
    ...
    "esp32_minimal": {
        "keywords": ["esp32", "wifi", "bluetooth", "iot", "wireless", "esp"],
        "description": "Minimal ESP32 module with power and programming header",
        "components": [
            {"type": "ic",        "ref": "U1", "label": "ESP32",  "zone": "center"},
            {"type": "regulator", "ref": "U2", "label": "AMS1117","zone": "left"},
            {"type": "capacitor", "ref": "C1", "label": "10uF",   "zone": "left",   "value": "10uF"},
            {"type": "capacitor", "ref": "C2", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "connector", "ref": "J1", "label": "USB/5V", "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "GPIO",   "zone": "right"},
            {"type": "connector", "ref": "J4", "label": "PROG",   "zone": "right"},
        ],
        "nets": [
            ["J1.1", "U2.IN", "C1.1"],
            ["U2.OUT", "U1.VCC", "C2.1", "R1.1"],
            ["R1.2", "U1.EN"],
            ["J2.1", "U2.GND", "U1.GND", "C1.2", "C2.2"],
            ["U1.GPIO0", "J4.1"],
            ["U1.TX", "J4.2"],
            ["U1.RX", "J4.3"],
            ["U1.GPIO2", "J3.1"],
    ...
    # -- COMMUNICATION ------------------------------------------
    "uart_level_shifter": {
        "keywords": ["uart", "level shifter", "rs232", "serial", "ttl"],
        "description": "UART TTL Level Shifter (3.3V to 5V bidirectional)",
        "components": [
            {"type": "mosfet",    "ref": "Q1", "label": "BSS138", "zone": "center"},
            {"type": "mosfet",    "ref": "Q2", "label": "BSS138", "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R3", "label": "10k",    "zone": "right",  "value": "10k"},
            {"type": "resistor",  "ref": "R4", "label": "10k",    "zone": "right",  "value": "10k"},
            {"type": "connector", "ref": "J1", "label": "3V3",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "5V",     "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "TX_LV",  "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "TX_HV",  "zone": "right"},
            {"type": "connector", "ref": "J5", "label": "RX_LV",  "zone": "left"},
            {"type": "connector", "ref": "J6", "label": "RX_HV",  "zone": "right"},
            {"type": "connector", "ref": "J7", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["J3.1", "R1.1", "Q1.S"],
            ["R1.2", "J1.1"],
    ...
    # -- OSCILLATORS & CLOCKS -----------------------------------
    "crystal_oscillator": {
        "keywords": ["crystal", "oscillator", "clock", "xtal", "crystal oscillator"],
        "description": "Crystal Oscillator with buffer gate",
        "components": [
            {"type": "crystal",   "ref": "Y1", "label": "16MHz",  "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "22pF",   "zone": "center", "value": "22pF"},
            {"type": "capacitor", "ref": "C2", "label": "22pF",   "zone": "center", "value": "22pF"},
            {"type": "resistor",  "ref": "R1", "label": "1M",     "zone": "center", "value": "1M"},
            {"type": "connector", "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "CLK",    "zone": "right"},
        ],
        "nets": [
            ["Y1.1", "C1.1", "R1.1"],
            ["Y1.2", "C2.1", "R1.2", "J3.1"],
    ...
    # -- PWM CONTROLLERS ----------------------------------------
    "pwm_led_dimmer": {
        "keywords": ["pwm", "dimmer", "led dimmer", "brightness", "pulse width"],
        "description": "555-based PWM LED Dimmer with potentiometer control",
        "components": [
            {"type": "ic",         "ref": "U1", "label": "NE555",  "zone": "center"},
            {"type": "potentiometer","ref": "RV1","label": "100k", "zone": "left"},
            {"type": "diode",      "ref": "D1", "label": "1N4148", "zone": "center"},
            {"type": "diode",      "ref": "D2", "label": "1N4148", "zone": "center"},
            {"type": "capacitor",  "ref": "C1", "label": "10nF",   "zone": "center", "value": "10nF"},
            {"type": "mosfet",     "ref": "Q1", "label": "IRF540",  "zone": "right"},
            {"type": "led",        "ref": "D3", "label": "LED",    "zone": "right"},
            {"type": "resistor",   "ref": "R1", "label": "100R",   "zone": "right",  "value": "100"},
            {"type": "connector",  "ref": "J1", "label": "VCC",    "zone": "left"},
            {"type": "connector",  "ref": "J2", "label": "GND",    "zone": "left"},
        ],
        "nets": [
            ["J1.1", "U1.VCC", "U1.RESET", "RV1.1"],
            ["RV1.W", "D1.A", "D2.K"],
            ["D1.K", "U1.DISCH"],
            ["D2.A", "U1.DISCH"],
            ["U1.THRESH", "U1.TRIG", "C1.1"],
            ["C1.2", "J2.1", "U1.GND", "Q1.S"],
            ["U1.OUT", "Q1.G"],
            ["Q1.D", "R1.1"],
            ["R1.2", "D3.A"],
            ["D3.K", "J1.1"],
    ...
    "voltage_divider": {
        "keywords": ["voltage divider", "divider", "attenuator", "reference"],
    ...
    # -- ADVANCED FUNCTIONAL BLOCKS -----------------------------
    "power_supply_module": {
        "keywords": ["power supply module", "buck", "boost", "converter", "12v to 5v", "12v to 3.3v", "smps"],
    ...
    "signal_conditioning": {
        "keywords": ["signal conditioning", "filter", "active filter", "analog to digital", "op-amp filter"],
        "description": "Active Low-Pass Filter and Amplifier for sensor signal conditioning",
        "components": [
            {"type": "opamp",     "ref": "U1", "label": "TL072",      "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",        "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "10k",        "zone": "center", "value": "10k"},
            {"type": "capacitor", "ref": "C1", "label": "10nF",       "zone": "center", "value": "10nF"},
            {"type": "capacitor", "ref": "C2", "label": "100nF",      "zone": "top",    "value": "100nF"},
            {"type": "connector", "ref": "J1", "label": "SENSOR_IN",  "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "ADC_OUT",    "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "VCC",        "zone": "top"},
            {"type": "connector", "ref": "J4", "label": "GND",        "zone": "bottom"},
        ],
        "nets": [
            ["J1.1", "R1.1"],
            ["R1.2", "R2.1", "C1.1"],
            ["R2.2", "U1.IN+", "C2.1"],
            ["U1.OUT", "U1.IN-", "C1.2", "J2.1"],
            ["C2.2", "J4.1", "U1.V-"],
            ["J3.1", "U1.V+"],
        ]
    },
    ...
    "protection_circuits": {
        ...
        "components": [
            ...
            {"type": "diode",     "ref": "D2", "label": "Zener 12V",  "zone": "center"},
    ...
    "full_bridge_rectifier": {
        "keywords": ["rectifier", "bridge", "ac to dc", "ac-dc", "full bridge", "diode bridge"],
        ...
        "components": [
            ...
            {"type": "diode",     "ref": "D3", "label": "1N4007", "zone": "center"},
            {"type": "diode",     "ref": "D4", "label": "1N4007", "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "1000uF", "zone": "right",  "value": "1000uF"},
            {"type": "connector", "ref": "J1", "label": "AC1",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "AC2",    "zone": "left"},
            {"type": "connector", "ref": "J3", "label": "DC+",    "zone": "right"},
            {"type": "connector", "ref": "J4", "label": "DC-",    "zone": "right"},
        ],
        "nets": [
            ["J1.1", "D1.A", "D2.K"],
            ["J2.1", "D3.A", "D4.K"],
    ...
    # -- COMPARATOR / SCHMITT -----------------------------------
    "schmitt_trigger": {
        "keywords": ["schmitt", "trigger", "comparator", "hysteresis", "threshold"],
        "description": "Schmitt Trigger Comparator with adjustable thresholds",
        "components": [
            {"type": "opamp",     "ref": "U1", "label": "LM358",  "zone": "center"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "left",   "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R3", "label": "100k",   "zone": "center", "value": "100k"},
            {"type": "connector", "ref": "J1", "label": "VIN",    "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "VCC",    "zone": "left"},
            {"type": "connector", "ref": "J4", "label": "GND",    "zone": "left"},
    ...
    # -- INSTRUMENTATION ----------------------------------------
    "instrumentation_amp": {
        "keywords": ["instrumentation", "ina", "differential", "strain gauge", "wheatstone"],
        "description": "Instrumentation Amplifier for precision measurements",
        "components": [
            {"type": "connector", "ref": "J1", "label": "SIG+",   "zone": "left"},
            {"type": "connector", "ref": "J2", "label": "SIG-",   "zone": "left"},
            {"type": "resistor",  "ref": "R1", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R2", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R3", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R4", "label": "10k",    "zone": "center", "value": "10k"},
            {"type": "resistor",  "ref": "R5", "label": "100k",   "zone": "center", "value": "100k"},
            {"type": "ic",        "ref": "U1", "label": "LM358",  "zone": "center"},
            {"type": "capacitor", "ref": "C1", "label": "100nF",  "zone": "center", "value": "100nF"},
            {"type": "connector", "ref": "J6", "label": "VOUT",   "zone": "right"},
            {"type": "connector", "ref": "J3", "label": "LOAD",   "zone": "right"},
            {"type": "connector", "ref": "J4", "label": "GND",    "zone": "left"},
            {"type": "connector", "ref": "J5", "label": "VCC",    "zone": "left"},
        ],
        "nets": [
            ["J1.1", "R1.1"],
            ["R1.2", "J3.1", "R2.1"],
...
# ===================================================================
# PCB DEEP KNOWLEDGE BASE -- Trained from Exhaustive PCB Research
# Covers: Materials, Board Topologies, Manufacturing, Soldering,
#         IPC Standards, Vanguard Technologies
# ===================================================================
...
PCB_KNOWLEDGE = {
    ...
    "board_types": {
        ...
        "entries": {
            "single_sided": {
                "keywords": ["single sided", "single layer", "one layer", "simple", "fr-1"],
                ...
                "layers": 1, "cost": "Lowest"
            },
            "double_sided": {
                "keywords": ["double sided", "double layer", "two layer", "pth", "plated through hole"],
                ...
                "layers": 2, "cost": "Low-Moderate"
            },
            "multi_layer": {
                "keywords": ["multi layer", "multilayer", "4 layer", "6 layer", "8 layer", "12 layer", "pdn", "ground plane"],
                ...
                "layers": "4-12+", "cost": "Moderate-High"
            },
            "flexible": {
                "keywords": ["flexible", "flex", "flex circuit", "bend", "polyimide flex", "wearable"],
            ...
            "rigid_flex": {
                ...
                "layers": "4-10+", "cost": "High"
            },
            "hdi": {
                "keywords": ["hdi", "high density", "microvia", "blind via", "buried via", "uhdi", "any layer"],
                ...
                "layers": "4-20+", "cost": "Very High"
            },
            "hdi_mobile": {
                "keywords": ["hdi mobile", "smartphone pcb", "phone motherboard", "mobile board", "iphone pcb", "android pcb"],
                ...
                "layers": "8-14", "cost": "Very High"
            },
            "fpc_mobile": {
                "keywords": ["fpc", "flex cable", "fpc mobile", "screen connector", "battery connector", "camera connector", "pet", "foldable phone"],
                ...
                "layers": "1-4", "cost": "Moderate"
            },
            "rigid_flex_mobile": {
                "keywords": ["rigid flex mobile", "camera module pcb", "phone rigid flex", "internal module"],
    ...
    "manufacturing": {
        ...
        "entries": {
            "step_overview": {
                "keywords": ["manufacturing", "fabrication", "how pcb made", "production", "process"],
            ...
            "lamination": {
                "keywords": ["lamination", "prepreg", "bonding", "stack up", "stackup"],
            ...
            "drilling": {
                "keywords": ["drilling", "cnc drill", "via hole", "mechanical drill", "laser drill"],
            ...
            "plating": {
                "keywords": ["plating", "electroless", "copper plating", "metallization", "electroplating"],
            ...
            "surface_finish": {
                "keywords": ["surface finish", "hasl", "enig", "osp", "immersion gold", "pad finish"],
            ...
            "etching": {
                "keywords": ["etching", "chemical etch", "cupric chloride", "ammonia etch", "subtractive"],
    ...
    "soldering": {
        ...
        "entries": {
            "smt_vs_tht": {
                "keywords": ["smt", "tht", "surface mount", "through hole", "component type"],
            ...
            "wave": {
                "keywords": ["wave solder", "wave soldering", "tht solder", "through hole solder"],
                "name": "Wave Soldering",
            ...
            "selective": {
                "keywords": ["selective solder", "selective soldering", "mixed assembly", "aperture"],
            ...
            "vapor_phase": {
                "keywords": ["vapor phase", "vps", "galden", "condensation", "void free"],
    ...
    "ipc_standards": {
        ...
        "entries": {
            ...
            "ipc_6012": {
                "keywords": ["ipc 6012", "rigid board", "qualification", "plating thickness"],
            ...
            "ipc_a610": {
                "keywords": ["ipc 610", "ipc-a-610", "assembly", "acceptability", "solder quality"],
            ...
            "design_rules": {
                "keywords": ["design rules", "clearance", "creepage", "trace width", "spacing", "3w rule"],
    ...
    "vanguard": {
        ...
        "entries": {
            "3d_printed": {
                "keywords": ["3d print", "additive", "ame", "nano dimension", "dragonfly", "nanoparticle"],
            ...
            "biodegradable": {
                "keywords": ["biodegradable", "soluboard", "jiva", "sustainable", "green", "eco", "cellulose"],
            ...
            "transient": {
                "keywords": ["transient", "dissolving", "resorbable", "biocompatible", "silk", "implant"],
            ...
            "liquid_metal": {
                "keywords": ["liquid metal", "egain", "gallium", "stretchable", "soft robot", "elastomer"],
            ...
            "impedance_control": {
                "keywords": ["impedance", "controlled impedance", "z0", "transmission line", "50 ohm", "return path"],
...
def fuzzy_match(prompt):
    """Fuzzy keyword-scoring to find the best circuit template match."""
...
def knowledge_search(query):
    """Search the PCB knowledge base for the most relevant entry."""
    query = query.lower().strip()
    best_entry = None
    best_score = 0
    best_category = None

    for cat_key, category in PCB_KNOWLEDGE.items():
        for entry_key, entry in category["entries"].items():
            score = 0
    ...
    return best_entry, best_category, best_score


@app.route('/')
def index():
    """Root status page."""
    templates = list(CIRCUIT_TEMPLATES.keys())
    return jsonify({
        "status": "running",
        "engine": "ALLEGRO X -- Autonomous Circuit Knowledge Engine v3.0",
        "templates_loaded": len(templates),
        "endpoints": {
            "POST /generate": "Send {\"prompt\": \"your circuit description\"}",
            "GET /templates": "List all available circuit presets",
        },
        "example_prompts": ["555 timer", "LED blinker", "5V power supply", "audio amplifier", "H-bridge motor driver", "ESP32 IoT"]
    })
...
def generate():
    ...
    print(f"Allegro X AI: Received prompt - '{prompt}'")

    key, score = fuzzy_match(prompt)

    if key and score > 0:
        tmpl = CIRCUIT_TEMPLATES[key]
        result = {
            "success": True,
            "autonomous": True,
            "template_id": key,
            ...
            "net_count": len(tmpl["nets"]),
        }
        print(f"  -> Matched template: {key} (score: {score})")
        return jsonify(result)
    else:
        return jsonify({
            "success": False,
            "message": f"Could not match '{prompt}' to a known circuit. Try: '555 timer', 'LED blinker', '5V power supply', 'audio amplifier', 'microcontroller', 'H-bridge motor driver', etc."
        })


@app.route('/templates', methods=['GET'])
def list_templates():
    """Returns all available circuit template names and descriptions for the UI preset dropdown."""
    presets = []
    for key, tmpl in CIRCUIT_TEMPLATES.items():
...
def get_knowledge():
    """Returns the full PCB knowledge base structure for UI browsing."""
    result = {}
    for cat_key, category in PCB_KNOWLEDGE.items():
        entries = []
        for ek, entry in category["entries"].items():
            e = {"id": ek, "name": entry["name"], "info": entry["info"]}
            if "specs" in entry:
                e["specs"] = entry["specs"]
            entries.append(e)
        result[cat_key] = {"title": category["title"], "entries": entries}
    return jsonify(result)


@app.route('/ask', methods=['POST'])
def ask_knowledge():
    """AI Q&A endpoint - searches the PCB knowledge base for answers."""
    data = request.json
    query = data.get('query', '')

    print(f"Allegro X Knowledge: Query - '{query}'")

    # First try knowledge base
    entry, category, score = knowledge_search(query)
    ...
    if entry and score > 0:
        ...
        if "specs" in entry:
            response["specs"] = entry["specs"]
        print(f"  -> Knowledge match: {entry['name']} (score: {score})")
        return jsonify(response)
    else:
        return jsonify({
            "success": False,
            "message": f"No knowledge match for '{query}'. Try asking about: FR-4, HDI, reflow soldering, IPC classes, differential pairs, 3D printed PCBs, etc."
        })


if __name__ == '__main__':
    total_knowledge = sum(len(c["entries"]) for c in PCB_KNOWLEDGE.values())
    print("===========================================================")
    print("  ALLEGRO X -- Autonomous Circuit Knowledge Engine v4.0")
    print(f"  Loaded {len(CIRCUIT_TEMPLATES)} circuit templates")
    print(f"  Loaded {total_knowledge} PCB knowledge entries (6 categories)")
    print("  Endpoints:")
    print("    POST http://localhost:5000/generate")
    print("    GET  http://localhost:5000/templates")
    print("    GET  http://localhost:5000/knowledge")
    print("    POST http://localhost:5000/ask")
    print("===========================================================")
